...
<link rel="stylesheet" href="{{ asset('assets/dashboard/css/styles.css') }}" />
  ...
  <title>{{ config('env.APP_NAME','laravel') }}</title>
</head>
        ...
        <div class="row justify-content-center w-100">
          <div class="col-lg-4">
            <div class="text-center">
              <img src="{{ asset('assets/dashboard/images/backgrounds/errorimg.svg') }}" alt="" class="img-fluid" width="500">
              <h1 class="fw-semibold mb-7 fs-9">Opps!!!</h1>
              <h4 class="fw-semibold mb-7">@yield('code') @yield('message')</h4>
