<div class="profile-dropdown position-relative" data-simplebar>
  ...
  <div class="message-body">
    ...
    <a href="" class="py-8 px-7 d-flex align-items-center">
      ...
      >
        <img
          src="{{asset('assets/dashboard/images/svgs/icon-inbox.svg')}}"
          alt=""
          width="24"
          height="24"
        />
    ...
    <a href="" class="py-8 px-7 d-flex align-items-center">
      ...
      >
        <img
          src="{{asset('assets/dashboard/images/svgs/icon-tasks.svg')}}"
          alt=""
          width="24"
          height="24"
        />
      ...
      <div class="row">
        ...
        <div class="col-6">
          <div class="m-n4 unlimited-img">
            <img
              src="{{asset('assets/dashboard/images/backgrounds/unlimited-bg.png')}}"
              alt=""
              class="w-100"
            />
          </div>
