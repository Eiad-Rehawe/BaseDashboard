    ...
    <ul class="mb-0">
      <li class="pb-7">
        <div class="d-flex align-items-center">
          <img
            src="{{asset('assets/dashboard/images/products/product-1.jpg')}}"
            width="95"
            height="75"
      ...
      <li class="pb-7">
        <div class="d-flex align-items-center">
          <img
            src="{{asset('assets/dashboard/images/products/product-2.jpg')}}"
            width="95"
            height="75"
            class="rounded-1 me-9 flex-shrink-0"
            alt=""
      ...
      <li class="pb-7">
        <div class="d-flex align-items-center">
          <img
            src="{{asset('assets/dashboard/images/products/product-3.jpg')}}"
            width="95"
            height="75"
            class="rounded-1 me-9 flex-shrink-0"
            alt=""
