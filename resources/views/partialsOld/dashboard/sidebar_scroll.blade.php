      ...
      <ul id="sidebarnav">
        ...
        <li class="sidebar-item">
          ...
          <ul aria-expanded="false" class="collapse first-level">
            ...
            <li class="sidebar-item">
              <a href="../rtl/index4.html" class="sidebar-link">
                <i class="ti ti-cpu"></i>
                <span class="hide-menu">Crypto</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a href="../rtl/index5.html" class="sidebar-link">
                <i class="ti ti-activity-heartbeat"></i>
                <span class="hide-menu">General</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a href="../rtl/index6.html" class="sidebar-link">
        ...
        <li class="sidebar-item mega-dropdown">
          ...
          <ul aria-expanded="false" class="collapse first-level">
            ...
            <li class="sidebar-item">
              <a
                href="../rtl/ui-tooltip-popover.html"
                class="sidebar-link"
              >
                <i class="ti ti-circle"></i>
        ...
        <li class="sidebar-item">
          ...
          <ul aria-expanded="false" class="collapse first-level">
            ...
            <li class="sidebar-item">
              <a
                href="../rtl/form-checkbox-radio.html"
                class="sidebar-link"
              >
                <i class="ti ti-circle"></i>
            ...
            <li class="sidebar-item">
              <a
                href="../rtl/form-bootstrap-touchspin.html"
                class="sidebar-link"
              >
                <i class="ti ti-circle"></i>
            ...
            <li class="sidebar-item">
              <a
                href="../rtl/form-bootstrap-switch.html"
                class="sidebar-link"
              >
                <i class="ti ti-circle"></i>
            ...
            <li class="sidebar-item">
              <a href="../rtl/form-dual-listbox.html" class="sidebar-link">
                <i class="ti ti-circle"></i>
            ...
            <li class="sidebar-item">
              <a
                href="../rtl/form-row-separator.html"
                class="sidebar-link"
              >
                <i class="ti ti-circle"></i>
        ...
        <li class="sidebar-item">
          ...
          <ul aria-expanded="false" class="collapse first-level">
            ...
            <li class="sidebar-item">
              <a
                href="../rtl/table-layout-coloured.html"
                class="sidebar-link"
              >
                <i class="ti ti-circle"></i>
            ...
            <li class="sidebar-item">
              <a
                href="../rtl/table-datatable-basic.html"
                class="sidebar-link"
              >
                <i class="ti ti-circle"></i>
            ...
            <li class="sidebar-item">
              <a
                href="../rtl/table-datatable-api.html"
                class="sidebar-link"
              >
                <i class="ti ti-circle"></i>
            ...
            <li class="sidebar-item">
              <a
                href="../rtl/table-datatable-advanced.html"
                class="sidebar-link"
              >
                <i class="ti ti-circle"></i>
