  ...
  >
    ...
    <li class="nav-item dropdown">
      ...
      <div
        ...
        aria-labelledby="drop2" id="noti"
      >
        <div class="d-flex align-items-center justify-content-between py-3 px-7">
<h5 class="mb-0 fs-5 fw-semibold">Notifications</h5>
<span class="badge text-bg-primary rounded-4 px-3 py-1 lh-sm" id="notifications_count"> </span>
</div>
...
<div class="w-75 d-inline-block v-middle">
  <span style="direction: rtl">إضافة طلب  بواسطة:</span>
  <h6 class="mb-1 fw-semibold lh-base"></h6><span></span>
...
<div class="py-3 px-7 pb-0" style="text-align:right">
...
<a
  href="../rtl/page-user-profile.html"
...
{{-- <a href="../rtl/authentication-login.html" class="btn btn-outline-primary"
  >Log Out</a
> --}}
...
<div class="offcanvas-header justify-content-between">
  <img src="{{ asset('assets/dashboard/images/logos/favicon.ico')}}" alt="" class="img-fluid" />
  <button
    type="button"
    class="btn-close"
      ...
      <ul aria-expanded="false" class="collapse first-level my-3">
        <li class="sidebar-item py-2">
          <a href="../rtl/app-chat.html" class="d-flex align-items-center">
            ...
            >
              <img
                src="{{ asset('assets/dashboard/images/svgs/icon-dd-chat.svg')}}"
                alt=""
                class="img-fluid"
                width="24"
                height="24"
        ...
        <li class="sidebar-item py-2">
          <a href="../rtl/app-invoice.html" class="d-flex align-items-center">
            ...
            >
              <img
                src="{{ asset('assets/dashboard/images/svgs/icon-dd-invoice.svg')}}"
                alt=""
                class="img-fluid"
                width="24"
                height="24"
        ...
        <li class="sidebar-item py-2">
          <a href="../rtl/app-cotact.html" class="d-flex align-items-center">
            <div
              class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center"
            >
              <img
                src="{{ asset('assets/dashboard/images/svgs/icon-dd-mobile.svg')}}"
                alt=""
                class="img-fluid"
                width="24"
                height="24"
        ...
        <li class="sidebar-item py-2">
          <a href="../rtl/app-email.html" class="d-flex align-items-center">
            ...
            >
              <img
                src="{{ asset('assets/dashboard/images/svgs/icon-dd-message-box.svg')}}"
                alt=""
                class="img-fluid"
                width="24"
                height="24"
        ...
        <li class="sidebar-item py-2">
          <a href="../rtl/page-user-profile.html" class="d-flex align-items-center">
            ...
            >
              <img
                src="{{ asset('assets/dashboard/images/svgs/icon-dd-cart.svg')}}"
                alt=""
                class="img-fluid"
                width="24"
                height="24"
        ...
        <li class="sidebar-item py-2">
          <a href="../rtl/app-calendar.html" class="d-flex align-items-center">
            ...
            >
              <img
                src="{{ asset('assets/dashboard/images/svgs/icon-dd-date.svg')}}"
                alt=""
                class="img-fluid"
                width="24"
                height="24"
        ...
        <li class="sidebar-item py-2">
          <a href="../rtl/app-contact2.html" class="d-flex align-items-center">
            ...
            >
              <img
                src="{{ asset('assets/dashboard/images/svgs/icon-dd-lifebuoy.svg')}}"
                alt=""
                class="img-fluid"
                width="24"
                height="24"
        ...
        <li class="sidebar-item py-2">
          <a href="../rtl/app-notes.html" class="d-flex align-items-center">
            ...
            >
              <img
                src="{{ asset('assets/dashboard/images/svgs/icon-dd-application.svg')}}"
                alt=""
                class="img-fluid"
                width="24"
                height="24"
        ...
        <ul class="px-8 mt-7 mb-4">
          ...
          <li class="sidebar-item py-2">
            <a class="fw-semibold text-dark" href="../rtl/page-pricing.html">Pricing Page</a>
          </li>
          <li class="sidebar-item py-2">
            <a class="fw-semibold text-dark" href="../rtl/authentication-login.html"
              >Authentication Design</a
            >
          </li>
          <li class="sidebar-item py-2">
            <a class="fw-semibold text-dark" href="../rtl/authentication-register.html">Register Now</a>
          </li>
          <li class="sidebar-item py-2">
            <a class="fw-semibold text-dark" href="../rtl/authentication-error.html">404 Error Page</a>
          </li>
          <li class="sidebar-item py-2">
            <a class="fw-semibold text-dark" href="../rtl/app-notes.html">Notes App</a>
          </li>
          <li class="sidebar-item py-2">
            <a class="fw-semibold text-dark" href="../rtl/page-user-profile.html">User Application</a>
          </li>
          <li class="sidebar-item py-2">
            <a class="fw-semibold text-dark" href="../rtl/page-account-settings.html">Account Settings</a>
          </li>
        </ul>
      </ul>
    </li>
    <li class="sidebar-item">
      <a class="sidebar-link" href="../rtl/app-chat.html" aria-expanded="false">
        <span>
...
<li class="nav-item d-none d-xl-block">
  <a href="../rtl/index.html" class="text-nowrap nav-link">
    <img
      src="{{ asset('assets/dashboard/images/logos/dark-logo.svg')}}"
      class="dark-logo"
      width="180"
      alt=""
    />
    <img
      src="{{ asset('assets/dashboard/images/logos/light-logo.svg')}}"
      class="light-logo"
      width="180"
      alt=""
    />
...
<div class="position-relative p-7 border-start h-100">
  ...
  <ul class="">
    <li class="mb-3">
      <a class="fw-semibold bg-hover-primary" href="../rtl/page-pricing.html"
        >Pricing Page</a
      >
    </li>
    <li class="mb-3">
      <a
        ...
        href="../rtl/authentication-login.html"
        >Authentication Design</a
      >
    </li>
    <li class="mb-3">
      <a
        class="fw-semibold bg-hover-primary"
        href="../rtl/authentication-register.html"
        >Register Now</a
      >
    </li>
    <li class="mb-3">
    ...
    <li class="mb-3">
      <a class="fw-semibold bg-hover-primary" href="../rtl/app-notes.html"
        >Notes App</a
      >
    </li>
    <li class="mb-3">
    ...
    <li class="mb-3">
      <a
        class="fw-semibold bg-hover-primary"
        href="../rtl/page-account-settings.html"
        >Account Settings</a
      >
    </li>
  </ul>
...
<li class="nav-item dropdown-hover d-none d-lg-block">
  <a class="nav-link" href="../rtl/app-chat.html">Chat</a>
</li>
<li class="nav-item dropdown-hover d-none d-lg-block">
  <a class="nav-link" href="../rtl/app-calendar.html">Calendar</a>
</li>
<li class="nav-item dropdown-hover d-none d-lg-block">
  <a class="nav-link" href="../rtl/app-email.html">Email</a>
</li>
</ul>
...
<span class="me-3">
  <img
    src="{{ asset('assets/dashboard/images/profile/user-2.jpg')}}"
    alt="user"
    class="rounded-circle"
    width="48"
    height="48"
...
<span class="me-3">
  <img
    src="{{ asset('assets/dashboard/images/profile/user-3.jpg')}}"
    alt="user"
    class="rounded-circle"
    width="48"
    height="48"
...
<span class="me-3">
  <img
    src="{{ asset('assets/dashboard/images/profile/user-4.jpg')}}"
    alt="user"
    class="rounded-circle"
    width="48"
    height="48"
...
<span class="me-3">
  <img
    src="{{ asset('assets/dashboard/images/profile/user-5.jpg')}}"
    alt="user"
    class="rounded-circle"
    width="48"
    height="48"
