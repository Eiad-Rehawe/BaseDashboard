...
class CouponsDataTable extends DataTable
{
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('code')->title(trans('table.code'))->addClass('text-center'),
            Column::make('value')->title(trans('table.value'))->addClass('text-center'),
            Column::make('expired_at')->title(trans('table.expired_date'))->addClass('text-center'),
